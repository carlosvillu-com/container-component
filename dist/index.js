...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containerGithub = __webpack_require__(160);

	var _containerGithub2 = _interopRequireDefault(_containerGithub);

	var _containerRandomUser = __webpack_require__(161);

	var _containerRandomUser2 = _interopRequireDefault(_containerRandomUser);

	__webpack_require__(162);

	_react2['default'].render(_react2['default'].createElement(_containerRandomUser2['default'], null), document.getElementById('main-randomUser'));
	_react2['default'].render(_react2['default'].createElement(_containerGithub2['default'], null), document.getElementById('main-github'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cvContanierComponent = __webpack_require__(159);

	var _cvContanierComponent2 = _interopRequireDefault(_cvContanierComponent);

	exports['default'] = { ContanierComponent: _cvContanierComponent2['default'] };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContanierComponent = (function (_React$Component) {
	  function ContanierComponent() {
	    _classCallCheck(this, ContanierComponent);

	    _get(Object.getPrototypeOf(ContanierComponent.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(ContanierComponent, _React$Component);

	  _createClass(ContanierComponent, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'cv-ContanierComponent' },
	        _react2['default'].createElement('img', { className: 'cv-ContanierComponent-image', src: this.props.avatar }),
	        _react2['default'].createElement(
	          'ul',
	          { className: 'cv-ContanierComponent-list' },
	          _react2['default'].createElement(
	            'li',
	            { className: 'cv-ContanierComponent-nick' },
	  ...
	  return ContanierComponent;
	})(_react2['default'].Component);

	exports['default'] = ContanierComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GithubUserContainer = (function (_React$Component) {
	  function GithubUserContainer(props) {
	    _classCallCheck(this, GithubUserContainer);

	    _get(Object.getPrototypeOf(GithubUserContainer.prototype), 'constructor', this).call(this, props);
	    this.state = {};
	  }

	  _inherits(GithubUserContainer, _React$Component);

	  _createClass(GithubUserContainer, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this = this;

	      fetch('https://api.github.com/search/users?q=carlosvillu').then(function (response) {
	        return response.json();
	      }).then(function (results) {
	        return results.items[0];
	      }).then(function (profile) {
	        return _this.setState({ username: profile.login, avatar: profile.avatar_url });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_src.ContanierComponent, this.state);
	    }
	  }]);

	  return GithubUserContainer;
	})(_react2['default'].Component);

	exports['default'] = GithubUserContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RandomUserContainer = (function (_React$Component) {
	  function RandomUserContainer(props) {
	    _classCallCheck(this, RandomUserContainer);

	    _get(Object.getPrototypeOf(RandomUserContainer.prototype), 'constructor', this).call(this, props);
	    this.state = {};
	  }

	  _inherits(RandomUserContainer, _React$Component);

	  _createClass(RandomUserContainer, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this = this;

	      fetch('http://api.randomuser.me').then(function (response) {
	        return response.json();
	      }).then(function (data) {
	        return data.results[0].user;
	      }).then(function (profile) {
	        return _this.setState({ username: profile.username, avatar: profile.picture.medium });
	      });
	    }
	  }, {
	    key: 'render',
	...
	exports['default'] = RandomUserContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".cv-ContanierComponent {\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  font-size: 14px; }\n  .cv-ContanierComponent-image {\n    height: 149.94px;\n    width: 149.94px; }\n  .cv-ContanierComponent-list {\n    list-style-type: none;\n    margin: 14px 0;\n    padding: 0; }\n", ""]);
